...
<section class="text-gray-700 body-font">
  <div class="container px-5 py-12 mx-auto">
    <div class="flex flex-col text-center w-full mb-10">
      <h1 class="sm:text-4xl text-3xl font-medium title-font mb-2 text-gray-900">Create Activities</h1>
    </div>
      ...
      <div class="flex flex-wrap mb-6 w-full">
        <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
          ...
          <input class="appearance-none block w-full bg-gray-200 text-gray-700 border {{ $errors->has('name') ? 'border-red-500' : '' }}
            ...
            type="text" name="name" placeholder="Fishing" value="{{ old('name') }}">
      ...
      <div class="flex flex-wrap mb-6 w-full">
        <div class="w-full px-3 mb-6 md:mb-0">
          ...
          <input class="appearance-none block w-full bg-gray-200 text-gray-700 border {{ $errors->has('details') ? 'border-red-500' : '' }}
            rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white"
            type="text" name="details" placeholder="about the activity" value="{{ old('details') }}">
      ...
      <div class="flex flex-wrap mb-6 w-full">
        <div class="w-full px-3 mb-6 md:mb-0">
          ...
          <textarea name="rules" rows="2" placeholder="rules of the activity"
            ...
            rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white">{{ old('rules') }}</textarea>
