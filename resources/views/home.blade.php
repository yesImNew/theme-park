...
<section class="text-gray-700 pb-24">
  <div class="container mx-auto flex px-5 sm:py-24 py-12 md:flex-row flex-col items-center">
    <div class="lg:max-w-lg lg:w-full md:w-1/2 w-5/6 mb-10 md:mb-0">
      <img class="object-cover object-center rounded p-4" alt="hero" src="{{ asset('img/undraw_beach.svg') }}">
      {{-- <img class="object-cover object-center rounded shadow-md bg-white p-4" alt="hero" src="{{ asset('img/undraw_beach.svg') }}"> --}}
    </div>
    <div class="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
      <h1 class="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900">Traalala Theme Park
      </h1>
      <p class="mb-8 leading-relaxed">
        Whether it’s an adrenaline-fuelled experience or a magical adventure, Traalala Theme Park has thrills for all.
        Given its serenity and beauty, it is among the most perfect places to visit in Maldives for couples and honeymooners.
      </p>
