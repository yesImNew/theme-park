...
<section class="text-gray-700 body-font">
  <div class="container px-5 py-12 mx-auto">
    <div class="flex flex-col text-center w-full mb-10">
      <h1 class="sm:text-4xl text-3xl font-medium title-font mb-2 text-gray-900">Edit Room Type</h1>
    </div>

    <form class="lg:w-2/3 w-full mx-auto mb-4 bg-white shadow-md rounded py-8 px-6"
      action="{{ route('room-types.update', $roomType) }}" method="POST">
      @csrf @method('PATCH')
      ...
      <div class="flex flex-wrap mb-6 w-full">
        <div class="w-full px-3 mb-6 md:mb-0">
          ...
          <input class="appearance-none block w-full bg-gray-200 text-gray-700 border {{ $errors->has('name') ? 'border-red-500' : '' }}
            ...
            type="text" name="name" placeholder="Ocean view" value="{{ old('name', $roomType->name) }}">
