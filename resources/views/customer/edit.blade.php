...
<section class="text-gray-700 body-font">
  <div class="container px-5 py-12 mx-auto">
    <div class="flex flex-col text-center w-full mb-10">
      <h1 class="sm:text-4xl text-3xl font-medium title-font mb-2 text-gray-900">Update Customer</h1>
    </div>

    <form class="lg:w-2/3 w-full mx-auto mb-4 bg-white shadow-md rounded py-8 px-6"
      action="{{ route('customers.update', $customer) }}" method="POST">
      @csrf @method('PATCH')
        ...
        <div class="w-full md:w-1/2 px-3">
          ...
          <div class="relative">
            ...
            <input class="appearance-none block w-full bg-gray-200 text-gray-700 border {{ $errors->has('phone_no') ? 'border-red-500' : '' }}
              ...
              type="text" name="phone_no" placeholder="7777777"
      ...
      <div class="flex items-center mx-3">
        ...
        <a class="bg-gray-600 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline inline-block"
          href="{{ url()->previous() == url()->current() ? route('customers.index') : url()->previous() }}">Back</a>
      </div>
