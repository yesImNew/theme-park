<div class="sm:hidden ml-auto relative" x-data="{ open : false }">
    ...
    <!-- Dark background -->
    <div class="fixed h-screen w-full top-0 left-0 bg-gray-800 opacity-25 z-30" x-show="open"
    ...
    <!-- Pannel -->
    <div class="w-3/4 fixed h-screen left-0 top-0 z-40 overflow-y-auto bg-white flex flex-col justify-between"
